...
type [<AllowNullLiteral>] SubGroupStackOptions =
    [<EmitIndexer>] abstract Item: name: string -> bool with get, set
...
type [<AllowNullLiteral>] TimelineOptions =
    ...
    abstract tooltipOnItemUpdateTime: U2<bool, {| template: obj option -> obj option |}> option with get, set
...
type [<AllowNullLiteral>] DataSet<'T> =
    ...
    /// <returns>The function returns an array with the ids of the added items.</returns>
    abstract add: data: U2<'T, ResizeArray<'T>> * ?senderId: IdType -> ResizeArray<IdType>
    /// <summary>Clear all data from the DataSet.</summary>
    /// <param name="senderId">Optional sender id.</param>
    /// <returns>The function returns an array with the ids of the removed items.</returns>
    ...
    /// <returns>Returns an unordered array containing all distinct values.</returns>
    ...
    /// <param name="options">Optional options.</param>
    /// <returns>
    /// When no item is found, null is returned when a single item was requested,
    ...
    /// </summary>
    /// <returns>The DataSet itself.</returns>
    abstract getDataSet: unit -> DataSet<'T>
    /// <summary>Get ids of all items or of a filtered set of items.</summary>
    /// <returns>ids of all items or of a filtered set of items.</returns>
    ...
    /// <summary>Find the item with maximum value of specified field.</summary>
    /// <returns>Returns null if no item is found.</returns>
    abstract max: field: string -> 'T
    /// <summary>Find the item with minimum value of specified field.</summary>
    /// <returns>Returns null if no item is found.</returns>
    ...
    /// <returns>Returns an array with the ids of the removed items.</returns>
    ...
    /// <returns>Returns an array with the ids of the updated items.</returns>
...
type [<AllowNullLiteral>] DataSetStatic =
    ...
    [<EmitConstructor>] abstract Create: options: DataSetOptions -> DataSet<'T>
    /// <summary>Creates an instance of DataSet.</summary>
    /// <param name="data">An Array with items.</param>
    /// <param name="options">DataSet options.</param>
    [<EmitConstructor>] abstract Create: ?data: ResizeArray<'T> * ?options: DataSetOptions -> DataSet<'T>
...
type [<AllowNullLiteral>] DataViewStatic =
    [<EmitConstructor>] abstract Create: items: ResizeArray<'T> -> DataView<'T>
...
type [<AllowNullLiteral>] Graph2d =
    ...
    abstract getWindow: unit -> {| start: DateTime; ``end``: DateTime |}
    ...
    abstract setData: data: {| groups: DataGroupCollectionType option; items: DataItemCollectionType option |} -> unit
...
type [<AllowNullLiteral>] Graph2dStatic =
    [<EmitConstructor>] abstract Create: container: HTMLElement * items: DataItemCollectionType * groups: DataGroupCollectionType * ?options: Graph2dOptions -> Graph2d
    [<EmitConstructor>] abstract Create: container: HTMLElement * items: DataItemCollectionType * ?options: Graph2dOptions -> Graph2d
...
type [<AllowNullLiteral>] Timeline =
    ...
    abstract getItemRange: unit -> {| min: DateTime; max: DateTime |}
    ...
    abstract moveTo: time: DateType * ?options: TimelineAnimationOptions * ?callback: ((obj) option -> unit) -> unit
    /// Create an event listener. The callback function is invoked every time the event is triggered.
    abstract on: ``event``: TimelineEvents * ?callback: ((obj) option -> unit) -> unit
    /// Remove an event listener created before via function on(event[, callback]).
    abstract off: ``event``: TimelineEvents * ?callback: ((obj) option -> unit) -> unit
    ...
    /// To unselect all selected items, call <c>setSelection([])</c>.
    /// </summary>
    abstract setSelection: ids: U2<IdType, ResizeArray<IdType>> * ?options: {| focus: bool; animation: TimelineAnimationOptions |} -> unit
    ...
    /// <param name="options">Timeline animation options. See <see cref="TimelineAnimationOptions" /></param>
    ...
    abstract focus: selection: obj option -> unit
    abstract on: ?``event``: string * ?callback: (obj option -> unit) -> unit
    abstract off: ``event``: string * ?callback: ((obj) option -> unit) -> unit

type [<AllowNullLiteral>] TimelineStatic =
    [<EmitConstructor>] abstract Create: container: HTMLElement * items: DataItemCollectionType * groups: DataGroupCollectionType * ?options: TimelineOptions -> Timeline
    [<EmitConstructor>] abstract Create: container: HTMLElement * items: DataItemCollectionType * ?options: TimelineOptions -> Timeline

type [<AllowNullLiteral>] TimelineStaticStatic =
    [<EmitConstructor>] abstract Create: id: HTMLElement * data: obj option * ?options: obj -> TimelineStatic
...
type [<AllowNullLiteral>] Network =
    ...
    abstract on: eventName: NetworkEvents * callback: ((obj) option -> unit) -> unit
    /// <summary>
    ...
    abstract off: eventName: NetworkEvents * ?callback: ((obj) option -> unit) -> unit
    /// <summary>
    ...
    abstract once: eventName: NetworkEvents * callback: ((obj) option -> unit) -> unit
    /// <summary>
    ...
    /// <returns>the DOM coordinates</returns>
    ...
    /// <returns>the canvas coordinates</returns>
    ...
    /// <returns>an array of nodeIds showing where the node is</returns>
    ...
    /// <returns>an array of edgeIds</returns>
    ...
    /// </summary>
    /// <returns>the current seed of the network.</returns>
    ...
    abstract getConnectedNodes: nodeOrEdgeId: IdType * ?direction: DirectionType -> U2<ResizeArray<IdType>, Array<{| fromId: IdType; toId: IdType |}>>
    ...
    abstract getSelection: unit -> {| nodes: ResizeArray<IdType>; edges: ResizeArray<IdType> |}
    ...
    abstract setSelection: selection: {| nodes: ResizeArray<IdType>; edges: ResizeArray<IdType> |} * ?options: SelectionOptions -> unit
    ...
    /// </summary>
    /// <returns>the current scale of the network</returns>
    abstract getScale: unit -> float
    /// <summary>Returns the current central focus point of the view in the form: { x: {Number}, y: {Number} }</summary>
...
type [<AllowNullLiteral>] NetworkStatic =
    ...
    [<EmitConstructor>] abstract Create: container: HTMLElement * data: Data * ?options: Options -> Network
...
type [<AllowNullLiteral>] Properties =
    ...
    abstract pointer: {| DOM: Position; canvas: Position |} with get, set
    abstract previousSelection: {| nodes: ResizeArray<string>; edges: ResizeArray<string> |} option with get, set

type [<AllowNullLiteral>] Callback =
    abstract callback: ?``params``: obj -> unit

type [<AllowNullLiteral>] Data =
    abstract nodes: DataSet<Node> with get, set
    abstract edges: DataSet<Edge> with get, set
...
type [<AllowNullLiteral>] Locales =
    [<EmitIndexer>] abstract Item: language: string -> LocaleMessages option with get, set
...
type [<AllowNullLiteral>] Options =
    ...
    abstract locales: Locales option with get, set
    abstract clickToUse: bool option with get, set
    abstract configure: NetworkConfigure option with get, set
...
type [<AllowNullLiteral>] NetworkConfigure =
    abstract enabled: bool option with get, set
    abstract filter: U3<string, ResizeArray<string>, bool> option with get, set
    abstract container: obj option with get, set
    abstract showButton: bool option with get, set

type [<AllowNullLiteral>] Color =
    abstract border: string option with get, set
    abstract background: string option with get, set
    abstract highlight: U2<string, {| border: string option; background: string option |}> option with get, set
    abstract hover: U2<string, {| border: string option; background: string option |}> option with get, set
...
type [<AllowNullLiteral>] NodeOptions =
    ...
    abstract ``fixed``: U2<bool, {| x: bool option; y: bool option |}> option with get, set
    abstract font: U2<string, Font> option with get, set
    abstract group: string option with get, set
    abstract hidden: bool option with get, set
    abstract icon: {| face: string option; code: string option; size: float option; color: string option |} option with get, set
    ...
    abstract margin: {| top: float option; right: float option; bottom: float option; left: float option |} option with get, set
    ...
    abstract widthConstraint: U3<float, bool, {| minimum: float option; maximum: float option |}> option with get, set
    abstract x: float option with get, set
    abstract y: float option with get, set

type [<AllowNullLiteral>] EdgeOptions =
    abstract arrows: U2<string, {| ``to``: U2<bool, ArrowHead> option; middle: U2<bool, ArrowHead> option; from: U2<bool, ArrowHead> option |}> option with get, set
    abstract endPointOffset: {| from: float option; ``to``: float option |} option with get, set
    abstract arrowStrikethrough: bool option with get, set
    abstract chosen: U2<bool, {| edge: bool option; label: bool option |}> option with get, set
...
type [<AllowNullLiteral>] Font =
    ...
    abstract vadjust: float option with get, set
    abstract multi: U2<bool, string> option with get, set
    abstract bold: U2<string, FontStyles> option with get, set
    abstract ital: U2<string, FontStyles> option with get, set
    abstract boldital: U2<string, FontStyles> option with get, set
    abstract mono: U2<string, FontStyles> option with get, set

type [<AllowNullLiteral>] FontStyles =
    abstract color: string option with get, set
    abstract size: float option with get, set
    abstract face: string option with get, set
